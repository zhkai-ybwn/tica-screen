 ...
 * @LastEditTime: 2023-11-27 13:48:23
 * @FilePath: \tica-energy-plant\src\views\alarm\HistoryAlarm.vue
 * @Description: 实时报警组件
 * 
    ...
    <div class="real-alarm-container">
        <div class="search-box">
            ...
            <a-select 
                ...
                style="width: 8.71%;height: 34px; margin-left: 2%;line-height: 34px;"
                placeholder="报警类型"
                allow-clear
                :get-popup-container="(triggerNode) => getPopupContainer(triggerNode)"
            ...
            <a-input-search
                ...
                enter-button
                allow-clear
                style="width: 20%;height: 34px; margin-left: 2%;line-height: 34px;"
...
const getData = async () => {
    ...
    const res = await axiosAPI.post(window.MANAGE.urls.lishigaojinglibiao, getParam())
    if (res.code === 200) {
